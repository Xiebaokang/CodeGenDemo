//  === start mlir =====
module {
  func.func public @GEMM_mnk1024x512x128_f32f32f32_TTmn4x4_BTmnk64x64x16(%arg0: memref<1024x128xf32, 1>, %arg1: memref<128x512xf32, 1>, %arg2: memref<1024x512xf32, 1>) attributes {func.op.name = "Matmul", func.state = "gpu", nvvm.kernel = 1 : i32} {
    affine.parallel (%arg3, %arg4) = (0, 0) to (16, 8) {
      ...
      affine.parallel (%arg5, %arg6) = (0, 0) to (16, 16) {
        ...
        %4 = affine.vector_load %arg0[%arg5 * 4 + %arg6 floordiv 4 + %c0 * 64 + %arg3 * 64, (%arg6 mod 4) * 4 + %c0_4] : memref<1024x128xf32, 1>, vector<4xf32>
        affine.vector_store %4, %alloca[%c0 * 4] : memref<4xf32, 5>, vector<4xf32>
        %5 = affine.vector_load %arg1[%arg5 + %arg6 floordiv 16 + %c0 * 16 + %c0_5, (%arg6 mod 16) * 4 + %arg4 * 64] : memref<128x512xf32, 1>, vector<4xf32>
        ...
        affine.for %arg7 = 0 to 128 step 16 {
          affine.if affine_set<(d0) : (-d0 + 96 >= 0)>(%arg7) {
            %11 = affine.vector_load %arg0[%arg5 * 4 + %arg6 floordiv 4 + %c0 * 64 + %arg3 * 64, (%arg6 mod 4) * 4 + %arg7 + 16] : memref<1024x128xf32, 1>, vector<4xf32>
            affine.vector_store %11, %alloca[%c0 * 4] : memref<4xf32, 5>, vector<4xf32>
            %12 = affine.vector_load %arg1[%arg5 + %arg6 floordiv 16 + %c0 * 16 + %arg7 + 16, (%arg6 mod 16) * 4 + %arg4 * 64] : memref<128x512xf32, 1>, vector<4xf32>
        ...
        affine.for %arg7 = 0 to 4 {
          ...
          affine.vector_store %9, %arg2[%arg3 * 64 + (((%arg5 * 16 + %arg6) mod 64) floordiv 16 + ((%arg5 * 16 + %arg6) floordiv 64 + (%c0 floordiv 4) * 4) * 4) * 4 + %arg7, %arg4 * 64 + (%arg6 mod 16 + (%c0 floordiv 4) * 16) * 4 + %c0] : memref<1024x512xf32, 1>, vector<4xf32>
        } {affine.loop = "unroll"}
      }
    }
    return
